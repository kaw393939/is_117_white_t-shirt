...
Stories are selected for what they let the reader notice or decide. They are not filler and they are not automatically evidence.

| ID | Story candidate | Type | Teaching use | Status/source need | Planned return |
| --- | --- | --- | --- | --- | --- |
| ST-001 | A white shirt appears in three invented shop windows. | Invented demonstration | Fact/story distinction and framing. | Ready; Chapter 1 source is project text | Opening, Chapter 1 |
| ST-002 | Standard Issue, Drift & Thread and Blank Canvas Co. answer one fixed brief. | Invented demonstration | Same object, different identity and visual language. | Ready; control record #99 | Chapters 1, 8, 15, 20 |
| ST-003 | A generated draft adds an unsupported shirt performance claim. | Invented demonstration | LLM confidence, verification and judgment. | Ready after #72/#77 | Chapters 4, 14, 21 |
| ST-004 | A person cannot find sizing or the complete checkout total. | Invented demonstration | UX and customer journey. | Ready as scenario; no invented observation | Chapters 17, 20, 21 |
| ST-005 | Shannon/packet-switching history explains a request’s journey. | Documented historical case | Make networking concrete. | Candidate; #105 | Chapter 18 |
| ST-006 | CERN’s Web proposal and release make a protocol decision memorable. | Documented historical case | Distinguish Internet from Web. | Candidate; #106 | Chapter 19 |
| ST-007 | Helvetica interviews present competing beliefs about neutral typography. | Film/source-led discussion | Type as cultural argument. | Candidate; #101/#103/#125 | Chapter 9 |
| ST-008 | Where Wizards Stay Up Late supplies a narrative route into ARPANET history. | Secondary historical narrative | Humanize collaboration and infrastructure. | Candidate; #105/#125 | Chapter 18 |
| ST-009 | Starbucks and selected brands in The Hero and the Outlaw show brand stories in context. | Published case/interpretation | Brand archetype and positioning. | [Dossier](../research/brand-stories.md): company sources inspected and edition verified; book passages still pending under #101 | Chapter 8, Appendix B |
| ST-010 | A client asks for “a website” when the business need is discovery, trust or sales. | Invented professional scenario | Reframe web work as presence and outcomes. | Ready as invented; #78 | Chapter 5 |
